...
import static ru.javaops.voting.data.RestaurantTestData.restaurant2;
...
public class VoteTestData {
    ...
    public static Vote vote1 = new Vote(VOTE_ID, LocalDate.now(), user, restaurant1);
    public static Vote vote2 = new Vote(VOTE_ID + 1 , LocalDate.now(), admin, restaurant2);
